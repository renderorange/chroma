...
func TestSettingsBugFix_PendingChangesPreventOverwrites(t *testing.T) {
...
func TestSettingsBugFix_MultipleConcurrentChanges(t *testing.T) {
...
func TestSettingsBugFix_ToggleControlsWork(t *testing.T) {
...
func TestSettingsBugFix_StaleChangesAreCleared(t *testing.T) {
...
func TestSettingsBugFix_SetBlendModePreserved(t *testing.T) {
