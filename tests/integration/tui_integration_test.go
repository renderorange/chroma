...
func TestTUIOSCCommunication(t *testing.T) {
...
func TestTUIModelAdjustments(t *testing.T) {
...
func TestPendingChangesSystem(t *testing.T) {
...
func TestMultipleParameterTypes(t *testing.T) {
